/* Playwright global setup — clone jaffle-shop once, reuse everywhere.
 *
 ...
 *
 * Fails loud when offline — the suite relies on the real upstream repo
...
const JAFFLE_URL = "https://github.com/dbt-labs/jaffle-shop.git";
...
export default async function globalSetup() {
  ...
  if (!alreadyCloned) {
    ...
    try {
      ...
      throw new Error(
        `Failed to clone jaffle-shop. Set OFFLINE=1 to skip E2E, or check network / GitHub access.\n${err.message}`
      );
    }
  } else {
