...
export function dbtVersionWarning(doc, kind) {
  ...
  if (kind === YAML_DOCUMENT_KINDS.DBT_SEMANTIC || kind === YAML_DOCUMENT_KINDS.DBT_SAVED_QUERIES) {
    return "dbt semantic layer YAML was detected without version: 2; treat this as dbt YAML, not DataLex-native YAML.";
  }
  return "dbt properties YAML was detected without version: 2; treat this as dbt YAML, not DataLex-native YAML.";
}
