...
Curated, production-relevant examples for onboarding and feature walkthroughs.
...
- [`model-examples/real-scenarios/fintech-risk-baseline.model.yaml`](real-scenarios/fintech-risk-baseline.model.README.md)
- [`model-examples/real-scenarios/fintech-risk-change.model.yaml`](real-scenarios/fintech-risk-change.model.README.md)
- [`model-examples/real-scenarios/retail-analytics-baseline.model.yaml`](real-scenarios/retail-analytics-baseline.model.README.md)
- [`model-examples/real-scenarios/retail-analytics-change.model.yaml`](real-scenarios/retail-analytics-change.model.README.md)
- [`model-examples/starter-commerce.model.yaml`](starter-commerce.model.README.md)
